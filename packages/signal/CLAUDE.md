...
- All mail, notification, broadcast, and provider exports
...
## Import Conventions
- ALWAYS import from root barrel: `import { mail, notify, broadcast } from '@strav/signal'`
- Subpath imports allowed for specific features: `import { Broadcast } from '@strav/signal/broadcast'` (client-side)
